import torch 
model = 'AlexNet'#'ResNet-18'#'AlexNet'#'ResNet-18'#'AlexNet'  # 'ResNet-18'
...
methods = ['Bayes']#['ERM']  # , 'FTNA', 'ReRam', 'Adv' , 'Bayes'
# Model parameters
...
# Used dataset                   
dataSet = 'Mnist'#'CIFAR10'#'Mnist'  # 'CIFAR10'
...
contin = False#True  # False  # train from scratch if contin == False
