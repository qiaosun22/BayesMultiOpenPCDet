...
def eval_simple(p1, p2, p3, p4, file, usability, sigma, 
...
# def eval_simple(p1, p2, p3, p4, s, n, cfg, model, dataloader, logger, save_path, dist_test=False, save_to_file=False, result_dir=None):
#     result_dir.mkdir(parents=True, exist_ok=True)
