...
class Opt():
    ...
    #                 % (cfg.EXP_GROUP_PATH, cfg.TAG, args.extra_tag))
        ...
        acc1 = eval_utils_multinomial.eval_simple(ckpt, p1, p2, p3, sigma, n, cfg, model, test_loader, logger, save_path, dist_test=dist_train, save_to_file=args.save_to_file, result_dir=eval_output_dir)
        print("----------")
        print(acc1)
        print("----------")
...
if __name__ == '__main__':
    ...
    for sigma in np.linspace(1e-31, 1.0, 21)[6: ]:
