...
from .. import backbones_2d, dense_heads#, roi_heads, backbones_3d
...
class Detector3DTemplate(nn.Module):
    def __init__(self, model_cfg, num_class, p1, p2, p3, dataset):
        super().__init__()
...
class PointPillar(Detector3DTemplate):
    def __init__(self, model_cfg, num_class, p1, p2, p3, dataset):
        super().__init__(model_cfg=model_cfg, num_class=num_class, p1=p1, p2=p2, p3=p3, dataset=dataset)
